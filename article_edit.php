...
if(!empty($_POST)){
    ...
    if($key){
        ...
        if(Article::updateArticle($article_id, $article_name, $article_price, $article_lager, $article_type, $brend_id, $article_description)){
...
$brends =Article::selectBrends();
if(isset($_GET['id']) and $brends){
    $id = (int)$_GET['id'];
    $article = Article::articleData($id);
    if($article){
        ?>
    <html>
    <head>
    ...
    <body>
        ...
        <a href="edit_articles.php">Nazad</a>
    </body>
</html>
